...
void update_buffer_objects()
{
  if (kCube == g_mesh_model)  
  {
    if (kTriangleSoup == g_mesh_type)
    {
    ...
    else if (kVlistTriangles == g_mesh_type)
    {
  ...
  // IBO
  if (kVlistTriangles == g_mesh_type)
  { 
